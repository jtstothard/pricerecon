...
class FacebookMarketplaceConnector(BaseConnector):
    ...
    def __init__(
        ...
        *,
        ...
        self.location = location or os.getenv("FB_MARKETPLACE_LOCATION", "Hazel Grove, Stockport")
        self.latitude = latitude or float(os.getenv("FB_MARKETPLACE_LAT", "53.363"))
        self.longitude = longitude or float(os.getenv("FB_MARKETPLACE_LON", "-2.117"))

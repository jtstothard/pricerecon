...
async def get_signals(
    ...
    for row in rows:
        ...
        if signal_type == "price_drop":
            old_price = Decimal(str(event_json.get("old_price"))) if event_json.get("old_price") else None
            new_price = Decimal(str(event_json.get("new_price"))) if event_json.get("new_price") else None

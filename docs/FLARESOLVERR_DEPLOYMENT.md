...
- `***REMOVED***/src/pricerecon/connectors/flaresolverr.py` - FlareSolverr client
- `***REMOVED***/src/pricerecon/connectors/template_connector.py` - Integration
- `***REMOVED***/src/pricerecon/connectors/templates/*.yml` - Connector configs
- `***REMOVED***/config.yml` - Runtime configuration
- `***REMOVED***/docker-compose.yml` - Deployment config
- `***REMOVED***/scripts/check_flaresolverr.sh` - Verification script
- `***REMOVED***/scripts/test_flaresolverr_connectors.py` - Live testing